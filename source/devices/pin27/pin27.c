...
#define PIN_27_BIT			(1 << 27)	//pin 27 - GPIO0
#define PIN_27_OFFSET		(27)		//pin 27 - GPIO0

#define PIN_60_BIT			(1 << 28)	//pin 28 - GPIO1
#define PIN_60_OFFSET		(28)		//pin 28 - GPIO1

#define PIN_65_BIT			(1 << 3)	//pin 3 - GPIO2
#define PIN_65_OFFSET		(3)			//pin 3 - GPIO2
